    ...
    return (
        <nav className="flex w-full items-center justify-between px-5 py-3 border-b border-gray-200 bg-white">
            ...
            <a href="https://www.buymeacoffee.com/cactoid" target="_blank">
                <Image width="187" height="30" src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important;width: 217px !important;" />
            </a>
        </nav>
    )
}